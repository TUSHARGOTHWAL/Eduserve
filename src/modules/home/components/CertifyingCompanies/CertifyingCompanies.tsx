...
export const CertifyingCompanies: React.FC<CertifyingCompaniesProps> = (
  ...
  return (
    <section className="max-w-7xl px-3 xl:px-0 w-full text-center mx-auto text-brand-light">
      ...
      Courses and Careers officially certified by
      </h3>
      ...
      <span className="text-orange-400 w-[300px] text-sm md:text-base cursor-pointer mt-10 block underline md:w-fit mx-auto text-center">
