...
export const Feedbacks: React.FC<FeedbacksProps> = (props: FeedbacksProps) => {
  return (
    <section className="max-w-7xl px-3 xl:px-0 w-full mx-auto text-brand-light mt-[100px] md:mt-[160px]">
      ...
      More than +2800 students recommend us throughout India!
      </h4>
      ...
      <div className="w-fit text-lg mx-auto text-orange-400 flex items-center gap-x-2 mt-14 cursor-pointer group">
