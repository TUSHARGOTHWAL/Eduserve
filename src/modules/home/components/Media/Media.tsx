...
export const Media: React.FC<MediaProps> = (props: MediaProps) => {
  ...
  return (
    <section className="max-w-7xl px-3 xl:px-0 pb-[100px] md:pb-[160px] mx-auto w-full text-brand-light">
      <h5 className="text-center text-xl">Our Appearances</h5>
      <div className="rounded-sm relative lg:h-[440.5px] mt-14 gap-y-4 gap-x-12 grid md:grid-cols-3 border border-orange-700 items-center px-4 md:px-[80px] lg:px-[120px] py-[60px]">
        ...
        <div className="col-span-2 flex flex-col gap-y-6">
          ...
          <div className="w-fit text-lg text-orange-400 flex items-center gap-x-2 mt-2 cursor-pointer group">
